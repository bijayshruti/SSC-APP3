...
if __name__ == "__main__":
    main()----  An error occurred: There are multiple elements with the same key='del_io_3'. To fix this, please make sure that the key argument is unique for each element you create......Traceback (most recent call last):
  File "/mount/src/ssc-app3/app.py", line 2766, in main
    show_exam_management()
    ~~~~~~~~~~~~~~~~~~~~^^
  File "/mount/src/ssc-app3/app.py", line 2578, in show_exam_management
    show_allocation_table_with_controls()
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^
  File "/mount/src/ssc-app3/app.py", line 2278, in show_allocation_table_with_controls
    if st.button("🗑️", key=f"del_io_{alloc.get('Sl. No.', '')}", help="Delete this entry"):
       ~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
streamlit.errors.StreamlitDuplicateElementKey: There are multiple elements with the same `key='del_io_3'`. To fix this, please make sure that the `key` argument is unique for each element you create....full code top to bottom...
